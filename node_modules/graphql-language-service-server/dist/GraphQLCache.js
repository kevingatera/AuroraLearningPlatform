...
var GraphQLCache = exports.GraphQLCache = function () {
  function GraphQLCache(configDir, graphQLConfig, watchmanClient) {
      ...
      return regeneratorRuntime.async(function _callee3$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 3:
              includes = projectConfig.includes;
              _context4.next = 6;
    ...
    this.getSchema = function _callee4(appName) {
      var projectConfig, _schema, schema, customDirectives, directivesSDL;
      ...
      return regeneratorRuntime.async(function _callee4$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 3:
              if (!_this._schemaMap.has(projectConfig.schemaPath)) {
                _context5.next = 6;
                break;
              }

              _schema = _this._schemaMap.get(projectConfig.schemaPath);
              return _context5.abrupt('return', _schema ? _this._extendSchema(_schema, projectConfig.schemaPath) : _schema);
            ...
            case 12:
              ...
              if (_this._graphQLFileListCache.has(_this._configDir)) {
                schema = _this._extendSchema(schema, projectConfig.schemaPath);
              }

              _this._schemaMap.set(projectConfig.schemaPath, schema);
